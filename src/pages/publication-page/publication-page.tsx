...
import { Container, Typography, Box, TextField, Paper, IconButton, Toolbar } from '@mui/material';
...
export const PublicationPage = () => {
  ...
  const { getPublication, getComments, createComment, loading: publicationLoading } = usePublication();
  ...
  useEffect(() => {
    const fetchPublication = async () => {
      ...
      try {
        const publicationData = await getPublication(id);
  ...
  if (publicationLoading || !publication) {
    return (
      <Container maxWidth="md" sx={{ py: 4 }}>
        <Typography variant="h6">Loading publication...</Typography>
      </Container>
    );
  }
            ...
            <Box sx={{ maxWidth: '600px', mx: 'auto', width: '100%' }}>
              ...
              <Paper elevation={0} sx={{ p: 3, mb: 3, borderRadius: 5 }}>
                ...
                <TextField
                  ...
                  sx={{ mb: 2 }}
                />
                <Button label={commentLoading ? 'Posting...' : 'Post Comment'} />
              </Paper>
